...
CREATE INDEX "idx_feedback_campaign_created" ON "lead_interaction_feedback"("campaign_id", "created_at");
CREATE INDEX "idx_feedback_lead_created" ON "lead_interaction_feedback"("lead_id", "created_at");
